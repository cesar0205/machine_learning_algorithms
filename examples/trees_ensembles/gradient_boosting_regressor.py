from supervised_learning.trees.gradient_boosting_trees import GradientBoostingRegressor
import numpy as np
...
def main():
    ...
    plt.plot(X, pred, 'o')
    plt.title("Gradient boosting regressor. Fitting the sin(x) function")
    plt.xlabel("x")
    plt.ylabel("y")
    plt.show()
